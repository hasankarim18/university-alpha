    ...
    <header class="site-header">
        <div class="container">
            <h1 class="school-logo-text float-left">
                <a href="<?php echo site_url(); ?>"><strong>University</strong> Alpha</a>
            </h1>
            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    ...
                    ?>
                    <ul>
                        <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 31) {
                        ...
                        <li <?php if (get_post_type() == 'campus') {
                            echo 'class="current-menu-item"';
                        } ?>><a href="<?php echo esc_url(get_post_type_archive_link('campus')); ?>">Campuses</a></li>
                ...
                <div class="site-header__util">
                    ...
                    <span id="menu_search_btn" class="search-trigger js-search-trigger"><i class="fa fa-search"
                            aria-hidden="true"></i></span>
                </div>
            </div>
        </div>
